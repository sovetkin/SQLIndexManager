using SQLIndexManager_WPF.Infrastructure.Consts;

namespace SQLIndexManager_WPF.Services
{
    //TODO It seems the responsibility of the class shall be split between model of the data presentation and services providing that data 
